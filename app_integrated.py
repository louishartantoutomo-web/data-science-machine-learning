...
if menu == "🏠 Overview":
    ...
    with col1:
        ...
        <div class="metric-card">
            <h3 style="color: #667eea; margin: 0;">📊 Total Data</h3>
    ...
    with col2:
        st.markdown("""
        <div class="metric-card">
            <h3 style="color: #667eea; margin: 0;">🔵 Clusters</h3>
            <h1 style="margin: 0.5rem 0;">{}</h1>
            <p style="color: #666; margin: 0;">K-Means Clusters</p>
        </div>
    ...
    with col3:
        st.markdown("""
        <div class="metric-card">
            <h3 style="color: #667eea; margin: 0;">🔴 Failure Types</h3>
            <h1 style="margin: 0.5rem 0;">{}</h1>
            <p style="color: #666; margin: 0;">Classification Classes</p>
        </div>
    ...
    with col4:
        ...
        <div class="metric-card">
            ...
            <p style="color: #666; margin: 0;">Input Variables</p>
        </div>
...
# ============================
    ...
    with col1:
        st.markdown("""
        <div class="metric-card">
            <h4 style="color: #667eea; margin: 0;">🤖 Model Type</h4>
            <h3 style="margin: 0.5rem 0;">XGBoost</h3>
            <p style="color: #666; margin: 0;">Classifier</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
        <div class="metric-card">
            <h4 style="color: #667eea; margin: 0;">🎯 Classes</h4>
            <h3 style="margin: 0.5rem 0;">{}</h3>
            <p style="color: #666; margin: 0;">Failure Types</p>
        </div>
        """.format(len(label_encoder.classes_)), unsafe_allow_html=True)
    ...
    with col3:
        st.markdown("""
        <div class="metric-card">
            <h4 style="color: #667eea; margin: 0;">📊 Features</h4>
...
# ============================
    ...
    if viz_type == "Clustering View":
        ...
        # Add centroids
        if st.checkbox("Show Centroids", value=True):
        ...
        if len(available_features) >= 3:
            ...
            with col2:
                y_feature = st.selectbox("Y-Axis:", available_features, index=1)
            with col3:
...
# ============================
    ...
    if st.button("🚀 Predict Now", use_container_width=True):
        ...
        with col1:
            st.markdown(f"""
            <div class="metric-card">
                <h3 style="color: #667eea; margin: 0;">🔵 Cluster Prediction</h3>
                <h1 style="margin: 0.5rem 0; color: #2c3e50;">Cluster {cluster_pred}</h1>
                <p style="color: #666; margin: 0;">Confidence: {confidence_cluster:.2f}%</p>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col2:
            ...
            st.markdown(f"""
            <div class="{box_class}">
                <h3 style="margin: 0;">{icon} Failure Prediction</h3>
                <h2 style="margin: 0.5rem 0;">{failure_pred}</h2>
                <p style="margin: 0;">Confidence: {confidence_failure:.2f}%</p>
            </div>
            """, unsafe_allow_html=True)
